...
<html>
  ...
  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
    ...
    <div class="text-center lg:w-2/3 w-full">
      ...
      <p class="leading-relaxed mb-8">welcome to your profile dashboard trainer.</p>
      <div class="flex justify-center">
        <button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">
            <form action="memberattendance.jsp" method="post">
                <input type="submit" value="Mark Attendance">
             </form>
        </button>
        <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg"> <form action="trainerlogout" method="post">
